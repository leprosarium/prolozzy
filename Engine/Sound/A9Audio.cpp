...
// BUFFERS
///////////////////////////////////////////////////////////////////////////////////////////////////
A9BUFFERPROTO a9Audio::BufferPrecache( const std::wstring & filename ) 
{ 
	int ret;
...
A9BUFFER a9Audio::BufferCreate( const std::wstring & filename, int flags ) { return NULL; }
...
// STREAMS
///////////////////////////////////////////////////////////////////////////////////////////////////
A9STREAM a9Audio::StreamCreate( const std::wstring & filename, int flags ) { return NULL; }
...
BOOL A9_Init( HWND hwnd, int api )
{
	...
	elog::snd() << "Audio init (api=" << api << ")." << std::endl;
